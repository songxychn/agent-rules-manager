...
const en = {
  ...
  "setup.confirmUpgrade": "Upgrade library",
  ...
  "profiles.addFilePreview": "Preview file",
  "profiles.addFileConfirm": "Add Markdown",
...
const zh: Record<TranslationKey, string> = {
  ...
  "profiles.addFilePreview": "预览文件变更",
  "profiles.addFileConfirm": "添加 Markdown",
