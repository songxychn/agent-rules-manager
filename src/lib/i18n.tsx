...
const en = {
  "history.historyBaseline": "History starting point",
  "history.baselinePreview": "Restore to before this history began",
  "history.baselineTime": "Before the first recorded operation",

  "history.createDirectory": "Restore empty directory",
  "history.removeProfileEffect": "Remove Profile “{id}”",
  "history.restoreProfileEffect": "Restore Profile “{id}”",
  "history.agentEffect": "{name}: {before} → {after}",
  "history.linkState": "Linked rules",

  "history.content": "Compare file contents",
  "nav.history": "Operation history",
  "history.intro": "Browse this machine’s operations and restore the state after a selected operation.",
  "history.scopeNote": "Recovery includes later operations across Profiles, Agents, projects and libraries on this machine. Filters only change the list. External editor saves are not versioned.",
  "history.all": "All operations",
  "history.profiles": "Profiles",
  "history.agents": "Agent connections",
  "history.recovery": "Recoveries",
  "history.filter": "Filter history",
  "history.refresh": "Refresh",
  "history.loading": "Loading history…",
  "history.empty": "No operations recorded yet.",
  "history.more": "Show more",
  "history.latest": "Latest operation",
  "history.archived": "View only",
  "history.pick": "Select an operation to preview recovery",
  "history.pickHint": "Preview shows the affected operations, file changes and any conflicts before recovery.",
  "history.after": "Restore to after this operation",
  "history.previewing": "Checking recovery…",
  "history.undoCount": "Later operations to undo ({count})",
  "history.files": "File changes ({count})",
  "history.result": "Recovery result",
  "history.checkPassed": "Checks passed. Recovery checks again before writing.",
  "history.conflicts": "Later changes prevent recovery",
  "history.conflictHint": "The following paths changed or cannot be safely accessed. No files have been changed.",
  "history.previewAgain": "Check again",
  "history.restore": "Restore to this state",
  "history.confirmTitle": "Restore to the selected state?",
  "history.confirmNote": "A backup is saved first. This recovery will appear in history and can be undone.",
  "history.success": "Recovery completed. Select the previous operation to undo this recovery.",
  "history.noChanges": "The managed paths already match this point.",
  "history.legacyRestored": "This snapshot was restored by an older rollback command. Its completion state cannot be reconstructed.",
  "history.legacyBoundary": "A legacy rollback interrupted this history chain. This record is available for reference only.",
  "history.details": "Snapshot details",
  "history.paths": "Affected paths",
  "history.before": "Now",
  "history.target": "After recovery",
  "history.missing": "Does not exist",
  "history.file": "File",
  "history.directory": "Directory",
  "history.link": "Linked to {target}",
  "history.profile": "Active Profile: {id}",
  "history.remove": "Remove",
  "history.restoreFile": "Restore file",
  "history.restoreLink": "Restore link",
  "history.removeDirectory": "Remove empty directory",
  "history.initialize": "Initialize rule library",
  "history.upgradeLibrary": "Upgrade rule library",
  "history.createProfile": "Create Profile",
  "history.deleteProfile": "Delete Profile",
  "history.activateProfile": "Activate Profile",
  "history.connectionChange": "Change Agent connections",
  "history.restoreHistory": "Restore history",
  "history.connect": "Connect {name}",
  "history.disconnect": "Disconnect {name}",
  "history.unknown": "Library operation",
  ...
  "settings.intro":
    "Language stays on this device. The desktop app can also check GitHub Releases and install updates without changing rule files.",
  ...
  "settings.update.eyebrow": "Desktop",
  "settings.update.title": "App updates",
  "settings.update.description": "Signed installers come from GitHub Releases. Checking or installing never writes your rule library.",
  "settings.update.current": "Installed version",
  "settings.update.check": "Check for updates",
  "settings.update.checking": "Checking…",
  "settings.update.upToDate": "This version is current.",
  ...
  "settings.update.downloadingUnknown": "Downloading update…",
  "settings.update.installing": "Installing update…",
  "settings.update.unavailable": "In-app updates run in the desktop app. This browser demo does not download installers.",
  "settings.update.error": "Could not check for updates: {message}",
  "settings.update.installError": "Could not install the update: {message}",
...
const zh: Record<TranslationKey, string> = {
  "history.historyBaseline": "历史起点",
  "history.baselinePreview": "恢复到这段历史开始之前",
  "history.baselineTime": "首条记录的操作之前",

  "history.createDirectory": "恢复空目录",
  "history.removeProfileEffect": "移除 Profile「{id}」",
  "history.restoreProfileEffect": "恢复 Profile「{id}」",
  "history.agentEffect": "{name}：{before} → {after}",
  "history.linkState": "使用规则链接",

  "history.content": "查看内容对比",
  "nav.history": "操作历史",
  "history.intro": "浏览本机操作，恢复到某次操作完成后的状态。",
  "history.scopeNote": "恢复会撤销此后本机各规则库、Profile 和 Agent（含项目接入）的操作；筛选只影响列表。外部编辑器的保存不属于版本记录。",
  "history.all": "全部操作",
  "history.profiles": "Profile 操作",
  "history.agents": "Agent 接入",
  "history.recovery": "恢复操作",
  "history.filter": "筛选历史",
  "history.refresh": "刷新",
  ...
  "history.more": "加载更多",
  "history.latest": "最近操作",
  "history.archived": "仅供查看",
  "history.pick": "选择一条记录，查看恢复预览",
  "history.pickHint": "预览会列出将撤销的操作、文件变化和冲突，确认后才会执行。",
  "history.after": "恢复到这次操作完成之后",
  "history.previewing": "正在检查恢复条件…",
  "history.undoCount": "将撤销此后的 {count} 次操作",
  "history.files": "文件变更（{count} 项）",
  "history.result": "恢复结果",
  "history.checkPassed": "检查通过，执行前会再次核对文件状态。",
  "history.conflicts": "发现后续修改，暂时无法恢复",
  "history.conflictHint": "以下路径发生了后续修改，或无法安全访问。本次检查未修改任何文件。",
  "history.previewAgain": "重新检查",
  "history.restore": "恢复到此状态",
  "history.confirmTitle": "恢复到所选状态？",
  "history.confirmNote": "执行前会保存备份；本次恢复也会进入历史，可再次撤销。",
  "history.success": "恢复完成。如需撤销本次恢复，可选择恢复前的最后一条操作。",
  "history.noChanges": "相关受管路径已与此恢复点一致。",
  "history.legacyRestored": "此快照已通过旧版回滚命令撤销，无法完整重建其操作完成后的状态。",
  "history.legacyBoundary": "旧版回滚中断了这段历史的恢复链，此记录仅供查看。",
  "history.details": "快照详情",
  "history.paths": "涉及路径",
  "history.before": "当前",
  "history.target": "恢复后",
  "history.missing": "不存在",
  "history.file": "文件",
  "history.directory": "目录",
  "history.link": "链接到 {target}",
  "history.profile": "启用 Profile：{id}",
  "history.remove": "移除",
  "history.restoreFile": "恢复文件",
  "history.restoreLink": "还原链接",
  "history.removeDirectory": "移除空目录",
  "history.initialize": "初始化规则库",
  "history.upgradeLibrary": "升级规则库",
  "history.createProfile": "创建 Profile",
  "history.deleteProfile": "删除 Profile",
  "history.activateProfile": "启用 Profile",
  "history.connectionChange": "变更 Agent 接入",
  "history.restoreHistory": "恢复历史状态",
  "history.connect": "接入 {name}",
  "history.disconnect": "断开 {name}",
  "history.unknown": "规则库操作",
  ...
  "settings.title": "设置",
  "settings.intro": "语言偏好只保存在本机。桌面端还可以检查并安装应用更新，不会改动规则文件。",
  ...
  "settings.update.eyebrow": "桌面端",
  "settings.update.title": "应用更新",
  "settings.update.description": "签名安装包来自 GitHub Releases。检查或安装都不会写入规则库。",
  "settings.update.current": "当前版本",
  "settings.update.check": "检查更新",
  "settings.update.checking": "正在检查…",
  "settings.update.upToDate": "已是最新版本。",
  "settings.update.available": "版本 {version} 可以安装。",
  "settings.update.notes": "更新说明",
  "settings.update.install": "安装并重启",
  "settings.update.downloading": "正在下载 {percent}%",
  "settings.update.downloadingUnknown": "正在下载更新…",
  "settings.update.installing": "正在安装更新…",
  "settings.update.unavailable": "应用内更新只在桌面端可用。浏览器演示不会下载安装包。",
  "settings.update.error": "无法检查更新：{message}",
  "settings.update.installError": "无法安装更新：{message}",
  "language.zh": "简体中文",
  "language.en": "English",
};
