...
const en = {
  "projection.ruleDocs": "Rules documentation",
  "brand.subtitle": "Let multiple agents share one set of base instructions",
  ...
  "notifications.retention": "The latest 100 notifications are saved on this device.",
  ...
  "notifications.emptyHint": "Updates and operation results will appear here.",
  ...
  "setup.upgradeTitle": "Use one AGENTS.md per Profile.",
  ...
  "setup.upgradePrompt":
    "This merges each Profile’s rules into AGENTS.md in their original order and keeps a rollback snapshot.",
  ...
  "runtime.current": "Rules up to date",
  ...
  "profiles.intro":
    "Each Profile has one AGENTS.md. Choose which Profile to use on this machine.",
  "profiles.machineLabel": "Selection scope",
  "profiles.machineLocal": "THIS MACHINE ONLY",
  "profiles.syncNote": "Profiles can sync across machines; each machine chooses its active rules.",
  ...
  "profiles.deletePrompt":
    "This deletes {profile} and its AGENTS.md. The latest snapshot can restore them.",
  "profiles.deleteConfirm": "Confirm deletion",
  "profiles.notSelected": "Available on this machine",
  "profiles.switch": "Switch Profile",
  "profiles.refresh": "Update rules",
  "profiles.switchQuestion": "Switch to this Profile?",
  "profiles.switchPrompt":
    "This switches only this machine to {profile} and updates its rules.",
  "profiles.refreshQuestion": "Update these rules?",
  "profiles.refreshPrompt": "This updates the local rules from {profile}'s AGENTS.md.",
  ...
  "profiles.create.body":
    "Create a Profile with its own AGENTS.md.",
  ...
  "profiles.create.entrypoint": "All rules for this Profile go here",
...
const zh: Record<TranslationKey, string> = {
  "projection.ruleDocs": "规则文档",
  "brand.subtitle": "让多个 agent 共用一套基础提示词",
  ...
  "notifications.unread": "通知中心，{count} 条未读",
  "notifications.retention": "在本机保留最近 100 条通知，随时回看。",
  "notifications.close": "关闭通知中心",
  "notifications.total": "共 {count} 条",
  "notifications.markRead": "全部已读",
  "notifications.clear": "清空历史",
  "notifications.empty": "暂无通知",
  "notifications.emptyHint": "操作结果和提醒会留在这里。",
  ...
  "setup.upgradeTitle": "每个 Profile 只保留一个 AGENTS.md。",
  ...
  "setup.upgradePrompt": "将每个 Profile 的规则按原顺序合并到 AGENTS.md，并保留可回滚快照。",
  ...
  "runtime.current": "规则已更新",
  "runtime.missing": "规则尚未生成",
  "runtime.stale": "源规则已变化",
  "runtime.conflict": "规则更新有冲突",
  "profiles.eyebrow": "可版本化的规则路由",
  "profiles.title": "Profile",
  "profiles.intro": "每个 Profile 只有一个 AGENTS.md，每台机器各自选择启用哪个 Profile。",
  "profiles.machineLabel": "选择范围",
  "profiles.machineLocal": "仅当前机器",
  "profiles.syncNote": "Profile 可在多台机器间同步，当前启用哪套规则由本机决定。",
